...
volatile boolean MaxSwitchesPerCycleHit = false;
#endif
...
#ifdef RPU_OS_DEBUG_SWITCHES
      if (numberOfSwitchesSeen>8) {
        MaxSwitchesPerCycleHit = true;
        continue;
      }
#endif
